...
var require_Draggable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Draggable = class extends React2.Component {
		...
		render() {
			...
			return /* @__PURE__ */ React2.createElement(DraggableCore, {
				...draggableCoreProps,
				onStart: this.onDragStart,
				onDrag: this.onDrag,
				onStop: this.onDragStop
			}, React2.cloneElement(onlyChild, {
				className,
				style: {
					...onlyChild.props.style,
					...style
...
var require_cjs = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Default = Draggable.default || Draggable;
...
function GridItem(props) {
	...
	newChild = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraggableCore, {
...
function GridLayout(props) {
	...
	const handleDragOver = (0, import_react.useCallback)((e) => {
		e.preventDefault();
		e.stopPropagation();
		if (isFirefox && !e.nativeEvent.target?.classList.contains(layoutClassName$1)) return false;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref: innerRef,
		className: clsx(layoutClassName$1, className),
		style: {
...
function ResponsiveGridLayout(props) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (widthChanged || breakpointPropChanged || breakpointsChanged || colsChanged) {
			...
			const currentMargin2 = getIndentationValue(propMargin, newBreakpoint);
			const currentPadding = propContainerPadding ? getIndentationValue(propContainerPadding, newBreakpoint) : null;
